...
let ProductsService = class ProductsService {
    ...
    async findAll(query, page = 1, limit = 20) {
        const where = query ? [{ name: (0, typeorm_2.ILike)(`%${query}%`) }, { sku: (0, typeorm_2.ILike)(`%${query}%`) }] : {};
    ...
    async findOne(id) { return this.repo.findOneByOrFail({ id }); }
    ...
    async remove(id) { await this.repo.delete(id); return { ok: true }; }
};
